...
void allsuff_basis_birth(tree& x, tree::tree_cp nx, size_t v, size_t c, xinfo& xi, dinfo& di, tree::npv& bnv,
                         std::vector<sinfo>& sv, sinfo& sl, sinfo& sr, std::vector<tree::tree_cp>& node_pointers, bool split=true);
...
// 
double dmvt_cpp(arma::vec x, arma::mat Sigma, arma::vec delta, int df, bool log_bool);
arma::mat hessian_cuts(arma::vec y, arma::vec mu_vect, arma::vec cuts);
arma::rowvec gradient_cuts(arma::vec y, arma::vec mu_vect, arma::vec cuts);
double log_post_cuts (arma::vec cuts_free, arma::vec y, arma::vec mu_vect);
arma::vec Newt_Raph_cuts(arma::vec y, arma::vec mu_vect, arma::vec cuts);


// funs for Omega update: -----------------
// 
